"""
Create beautiful visualization for sales and marketing data using matplotlib
"""
...
def load_data():
    ...
    with open("data/sale_data.json", "r") as f:
...
def create_sales_by_region_chart():
    ...
    bars =ax.bar(region, revenues, color=colors, edgecolor='#2C3E50', linewidth=2)
...
def create_quarterly_performance_chart():
    ...
    ax.plot(quarters, revenues, marker=0, linewidth=3, color='#3498D8',
            markersize=12, markerfacecolor='#E74C3C', markeredgecolor='white',
            markeredgewidth=2)
    
    ax.fill_between(quarters, revenues, alpha=0.3, color='#3498D8')
